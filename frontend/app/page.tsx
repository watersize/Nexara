...
function createWorkspaces() {
  return [
    ...
    },
    {
      id: 'notebook',
      title: 'Блокнот',
      description: 'Заметки, рисунки, фото, графики и форматирование в одном рабочем пространстве.',
      href: '/notebook',
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        ...
        <div className="mx-auto max-w-6xl">
          <section className="mb-16 text-center animate-slide-up">
            ...
            <p className="mx-auto max-w-2xl text-lg leading-relaxed text-muted-foreground text-pretty sm:text-xl">
              Расписание, учебники, AI-чат, задачи и заметки. Всё в одном месте и с общим контекстом.
            </p>
          </section>
          ...
          <section className="mb-12 grid grid-cols-2 gap-4 sm:grid-cols-4">
            ...
            <StatCard label="Активных задач" value={tasksCount} />
          </section>

          <section className="mb-16">
            <div className="mb-6 flex items-center justify-between">
              <h2 className="text-xl font-semibold text-foreground">Рабочие пространства</h2>
              <span className="text-sm text-muted-foreground">Все основные разделы</span>
            </div>
