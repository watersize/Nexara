...
import { ChevronLeft, ChevronRight, Eye, EyeOff, FileOutput, Ghost, Grid3x3, ImagePlus, Layers3, Lock, NotebookPen, PenTool, Plus, Ruler, Save, Sparkles, Table2, Unlock, Workflow } from 'lucide-react'
